...
[![Deploy on Railway](https://railway.com/button.svg)](https://railway.com/template/kwZH1x?referralCode=sdWvqO)

After deploying, select your chatbot node and disconnect the Github repo. When you re-add it you can select your personal branch. Press Ctrl/Cmd + K to reload your deployment from that change.
