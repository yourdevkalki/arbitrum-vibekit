#!/usr/bin/env node
/**
 * CLI Entry Point Loader
 * Loads environment variables before importing the main CLI module
 */
...
// Now import and run the CLI (this will import config.ts with env vars already loaded)
